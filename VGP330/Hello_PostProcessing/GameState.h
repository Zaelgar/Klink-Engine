...
private:
	...
	using PostOptionsBuffer = Klink::Graphics::TypedConstantBuffer<PostOptionsData>;

	PostOptionsBuffer mPostOptionsBuffer;
	PostOptionsData mPostOptions;

	RenderTarget mRenderTarget;
	BaseMesh<VertexPX> mScreenMesh;
	Klink::Graphics::MeshBuffer mScreenMeshBuffer;

	Klink::Graphics::VertexShader mPostProcessVertexShader;
	Klink::Graphics::PixelShader mPostProcessPixelShader;
};
